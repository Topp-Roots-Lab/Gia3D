...
int Voxels::get_nr_nonshared_faces(VoxelType *nb)
{
	int f=0;
	//count faces
	if(nb[4]==0) f++;		
...
int Voxels::get_nr_nonshared_edges(VoxelType *nb)
{
	int e=0;
	//count edges
...
int Voxels::get_nr_nonshared_vertices(VoxelType *nb)
{
	int v=0;
	//count vertices
...
void Voxels::get_neighbours_index(int i, vector<int> &nb)
{
	nb[0] = i-wxh - width - 1;
	nb[1] = i-wxh - width;
	nb[2] = i-wxh - width + 1;
